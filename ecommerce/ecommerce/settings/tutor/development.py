...
CORS_ORIGIN_WHITELIST.append("http://apps.local.overhang.io:7296")
CSRF_TRUSTED_ORIGINS = ["apps.local.overhang.io:7296"]



CORS_ORIGIN_WHITELIST.append("http://apps.local.overhang.io:1998")
